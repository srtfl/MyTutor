    ...
    <div className="relative w-screen h-screen overflow-hidden bg-zinc-950">
      ...
      <div className="absolute inset-0 z-10 pointer-events-none flex text-white">
        ...
        <aside className="w-[340px] h-full pointer-events-auto bg-zinc-950/95 backdrop-blur-xl border-r border-zinc-800 flex flex-col justify-between p-4 shrink-0 shadow-2xl">
          <div className="space-y-4 flex-1 flex flex-col min-h-0">
            <div className="flex items-center justify-between shrink-0">
              ...
              <div className="flex items-center gap-1.5 bg-zinc-900 px-2.5 py-1 rounded-full border border-zinc-800 text-xs">
                <Users className="w-3.5 h-3.5 text-zinc-400" />
                <span className="font-mono">{peerCount}</span>
              </div>
            </div>

            <div className="flex-1 flex flex-col min-h-0 bg-zinc-900 border border-zinc-800 rounded-lg overflow-hidden shadow-inner">
              <div className="bg-zinc-950 p-3 border-b border-zinc-800 flex items-center gap-2 shrink-0">
        ...
        <main className="flex-1 relative">
          {activeQuestion && (
            <div className="pointer-events-auto absolute top-6 left-6 w-full max-w-[420px] max-h-[80vh] overflow-y-auto bg-zinc-950/95 backdrop-blur-md border border-zinc-800 shadow-2xl rounded-xl p-5 animate-in slide-in-from-left-8 fade-in duration-300">
